...
import co.id.artslv.lib.transactions.Cancellationtype;
...
@Entity
@Table(name = "KAIRTS_T_REFUNDMANUAL")
public class Refundmanual_x implements Serializable {

    @Id
    @GeneratedValue(generator = "uuid")
    @GenericGenerator(name = "uuid", strategy = "uuid2")
    @Column(name = "C_REFUNDMANUAL_ID")
    private String id;
    ...
    @Column(name = "C_REFUNDMANUAL_DATE")
    private LocalDate date;
    @Column(name = "C_REFUNDMANUAL_DOCTITLE")
    private String doctitle;
    @Column(name = "C_REFUNDMANUAL_DOCNUM")
    private int docnum;
    ...
    @Column(name = "C_REFUNDMANUAL_TOTTICKET")
    private int totticket;
    @Column(name = "C_REFUNDMANUAL_TICKETAMOUNT")
    private BigDecimal ticketamount;
    @Column(name = "C_REFUNDMANUAL_FEEAMOUNT")
    private BigDecimal feeamount;
    @Column(name = "C_REFUNDMANUAL_REFUNDAMOUNT")
    private BigDecimal refundamount;
    @Column(name = "C_REFUNDMANUAL_REASON")
    private String reason;
    @Column(name = "C_REFUNDMANUAL_STATUS")
    private String status;
    @Column(name = "C_REFUNDMANUAL_DOMAIN")
    private String domain;
    @Column(name = "C_REFUNDMANUAL_MODIFIEDBY")
    private String modifiedby;
    @JsonSerialize(using = LocalDateTimeSerializer.class)
    @JsonDeserialize(using = LocalDateTimeDeserializer.class)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Type(type = "org.hibernate.type.LocalDateTimeType")
    @Column(name = "C_REFUNDMANUAL_MODIFIEDON")
